...
void EdgeShader::setMaterial(const GLMmaterial & meterial, textureManager & manager)
{
	bindParemeter();
}
void EdgeShader::begin()
{
	m_loader.useShder();
	bindParemeter();
}
