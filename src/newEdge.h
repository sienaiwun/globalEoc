...
#ifndef NEWEDGESHADDER_H
#define NEWEDGESHADDER_H
class Fbo;
class Camera;

class NewEdgeShader :public glslShader
{
public:
	NewEdgeShader()
	{
		m_vertexFileName = "Shader/newEdge.vert";
		m_fragmentFileName = "Shader/newEdge.frag";
		m_pCamera = NULL;
	}
	virtual void init();
...
private:
	...
	GLuint m_cameraPos_slot, m_projection_slot;
